      ...
      />
      {
        total !== null ? 
          total > 0 ?
            ...
            total === 0 ?
              <h3>At least you didn't lose anything! Your bets evened out.</h3> :
              <h3>{`Better luck next time! You lost $${-total}`}</h3> :
          <h3><span style={{color: 'red'}}>WARNING: </span>Returning to the betting table will reset your bets!</h3>
      }
    </div>
